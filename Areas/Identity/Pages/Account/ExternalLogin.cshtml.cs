...
namespace LibraryCodingNight.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            if (info == null)
            {
                ErrorMessage = "Błąd ładowania zewnętrznych danych logowania.";
                return RedirectToPage("./Login", new { ReturnUrl = returnUrl });
            }
            ...
            if (result.Succeeded)
            {
                _logger.LogInformation("{Name} zalogował się u dostawcy {LoginProvider}.", info.Principal.Identity.Name, info.LoginProvider);
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (info == null)
            {
                ErrorMessage = "Błąd ładowania danych logowania zewnętrznego podczas potwierdzania.";
                return RedirectToPage("./Login", new { ReturnUrl = returnUrl });
            }
        ...
        private ApplicationUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"Nie można utworzyć instancji '{nameof(ApplicationUser)}'. " +
                    ...
                    $"zastąp zewnętrzną stronę logowania w /Areas/Identity/Pages/Account/ExternalLogin.cshtml");
            }
        }
